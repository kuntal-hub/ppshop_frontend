...
export default function CreateReport({ setShowCreateReport, amount, eId,setPage }) {
    ...
    const createReport = async()=>{
        ...
        setIsDisabled(true)
        const data = {
            fiveh: isNaN(fiveh) ? 0 : fiveh,
            twoh: isNaN(twoh) ? 0 : twoh,
            oneh: isNaN(oneh) ? 0 : oneh,
            fifty: isNaN(fifty) ? 0 : fifty,
            twenty: isNaN(twenty) ? 0 : twenty,
            ten: isNaN(ten) ? 0 : ten,
